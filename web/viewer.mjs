...
{
  const HOSTED_VIEWER_ORIGINS = new Set(["null", "http://mozilla.github.io", "https://mozilla.github.io", "https://gopress.online"]);
...
document.addEventListener("contextmenu", function(e) {
    ...
    const menu = document.getElementById("con-menu");
...
document.addEventListener("click", function(e) {
  ...
  const message = document.getElementById("select-msg");
